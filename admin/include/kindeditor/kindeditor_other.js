...
(function(w, i) {
    ...
    if (!w.KindEditor) {
        ...
        f.options = {
            ...
            minChangeSize: 50,
            zIndex: 811213,
            items: ["source", "|", "undo", "redo", "|", "fontsize", "forecolor", "hilitecolor", "bold", "italic", "underline", "strikethrough", "formatblock", "|", "insertorderedlist", "insertunorderedlist", "indent", "outdent", "lineheight", "|", "wordpaste", "removeformat", "fullscreen", "/", "justifyleft", "justifycenter", "justifyright", "|", "link", "unlink", "|", "image", "multiimage", "media", "table", "hr", "baidumap", "pagebreak", "anchor", "|", "about"],
            ...
            htmlTags: {
                ...
                "p,ol,ul,li,dl,dt,dd,blockquote,h1,h2,h3,h4,h5,h6": ["id", "class", "align", ".text-align", ".color", ".background-color", ".font-size", ".font-family", ".background", ".font-weight", ".font-style", ".text-decoration", ".vertical-align", ".text-indent", ".margin-left"],
                pre: ["id", "class"],
        ...
        E(ab, {
            ...
            submit: function() {
                ...
                function() {
					...
					thumbimg2 = document.getElementById("thumbimg2");
					thumbimg3 = document.getElementById("thumbimg3");
					if(g.url && !thumbimg.value){
						thumbimg.value = g.url
					}else if(g.url && thumbimg.value && !thumbimg2.value){
						thumbimg2.value = g.url
					}else if(g.url && thumbimg.value && thumbimg2.value && !thumbimg3.value){
						thumbimg3.value = g.url
					}
