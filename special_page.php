...
function listOne($categoryTable){
    ...
    $limit = $dou->special_pager($categoryTable, ($show_list), $page, $dou->rewrite_special_url('article_category', $cat_id), $where);
...
function listTwo($categoryTable,$articleTable){
    ...
    $cat_list = array(
        'title' => $cat_name,
        'backUrl' => $dou->rewrite_special_url('article_category',$cat_id)
