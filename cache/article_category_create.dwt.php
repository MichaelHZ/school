<?php /* Smarty version 2.6.26, created on 2017-09-30 00:29:02
         compiled from article_category_create.dwt */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
...
<?php endif; ?>"><?php echo $this->_tpl_vars['child']['cat_name']; ?>
		...
		<article id="neirong">
                                    ...
                                    <div id="NavList">
                                        <?php $_from = $this->_tpl_vars['nav_create_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }$this->_foreach['nav_create_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_create_list']['total'] > 0):
    foreach ($_from as $this->_tpl_vars['nav']):
        $this->_foreach['nav_create_list']['iteration']++;
?> 
                                        <h3 class="Nav_title"><?php echo $this->_tpl_vars['nav']['nav_name']; ?>
</h3>
...
?> 
                                        <div class="SortList">
                                                    ...
                                                    <h4><span><?php echo $this->_tpl_vars['child']['nav_alias']; ?>
</span><?php echo $this->_tpl_vars['child']['nav_name']; ?>
</h4>
...
" target="_blank"><?php echo $this->_tpl_vars['sub']['nav_alias']; ?>
<?php echo $this->_tpl_vars['sub']['nav_name']; ?>
</a></li>
                                                        <?php endforeach; endif; unset($_from); ?> 
														<?php endif; ?>
                                                    </ul>
