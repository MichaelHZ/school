<?php /* Smarty version 2.6.26, created on 2017-09-28 12:28:57
         compiled from article_category_music.dwt */ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8" />
...
?> 
                            <li>
                            	<ins><?php echo $this->_tpl_vars['article']['count']; ?>
</ins>
...
" alt="图片描述" />			
                            	...
                            	<a href="<?php if ($this->_tpl_vars['article']['custom_url']): ?><?php echo $this->_tpl_vars['article']['custom_url']; ?>
?cat_id=<?php echo $this->_tpl_vars['article']['cat_id']; ?>
<?php else: ?><?php echo $this->_tpl_vars['article']['url']; ?>
<?php endif; ?>" target="_blank"><span class="icon_video"></span></a>
                            </li>
                            <?php endforeach; endif; unset($_from); ?> 
