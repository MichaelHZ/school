<?php /* Smarty version 2.6.26, created on 2017-10-12 21:27:14
    ...
    <div class="navList">
     <ul class="tab">
      ...
      <li><a href="nav.php?type=bottom"<?php if ($this->_tpl_vars['type'] == 'bottom'): ?> class="selected"<?php endif; ?>><?php echo $this->_tpl_vars['lang']['nav_type_bottom']; ?>
       ...
       <li><a href="nav.php?type=group"<?php if ($this->_tpl_vars['type'] == 'group'): ?> class="selected"<?php endif; ?>><?php echo $this->_tpl_vars['lang']['nav_type_group']; ?>
</a></li>
	    <li><a href="nav.php?type=index"<?php if ($this->_tpl_vars['type'] == 'index'): ?> class="selected"<?php endif; ?>>右浮动栏</a></li>
     </ul>
...
"><?php echo $this->_tpl_vars['catalog']['mark']; ?>
 <?php echo $this->_tpl_vars['catalog']['name']; ?>
           ...
           <tr>
            ...
            <tr>
            <td width="80" height="35" align="right">别名</td>
            <td>
             <input type="text" id="nav_alias" name="nav_alias" value="" size="40" class="inpMain" />
            </td>
           </tr>
           <tr>
           <td width="80" height="35" align="right">栏目图</td>
           <td>
            <input type="file" id="image" name="image" value="" size="40" class="inpMain" />
           </td>
           </tr>
           <tr>
...
', 'type', this.value, 'parent')">
			  ...
			  <!--
               <label for="type_3">
              <input type="radio" name="type" id="type_3" value="create" onChange="dou_callback('nav.php?rec=nav_select&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')">
              <?php echo $this->_tpl_vars['lang']['nav_type_create']; ?>
</label>
			  -->
               <label for="type_4">
               <input type="radio" name="type" id="type_4" value="group" onChange="dou_callback('nav.php?rec=nav_select&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')">
              <?php echo $this->_tpl_vars['lang']['nav_type_group']; ?>
</label>
			   <label for="type_5">
               <input type="radio" name="type" id="type_5" value="index" onChange="dou_callback('nav.php?rec=nav_select&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')">
              右浮动栏</label>
            </td>
           </tr>
         ...
         <form action="nav.php?rec=insert" method="post" enctype="multipart/form-data">
          <table width="100%" border="0" cellpadding="5" cellspacing="1" class="tableBasic">
           ...
           <tr>
            <td width="80" height="35" align="right">别名</td>
            <td>
             <input type="text" name="nav_alias" value="" size="40" class="inpMain" />
            </td>
           </tr>
           <tr>
            <td width="80" height="35" align="right">栏目图</td>
...
', 'type', this.value, 'parent_external')">
 <?php echo $this->_tpl_vars['lang']['nav_type_group']; ?>
  ...
  <label for="type_5">
 <input type="radio" name="type" id="type_4" value="index" onChange="dou_callback('nav.php?rec=nav_select&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent_external')">
 右浮动栏</label>
            </td>
           </tr>
...
" size="40" class="inpMain" />
      ...
      <tr>
       <td width="80" height="35" align="right">别名</td>
       <td>
        <input type="text" id="nav_alias" name="nav_alias" value="<?php echo $this->_tpl_vars['nav_info']['nav_alias']; ?>
" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <td><?php if (! empty ( $this->_tpl_vars['nav_info']['image'] )): ?><span><img width="100px" src="/<?php echo $this->_tpl_vars['nav_info']['image']; ?>
"></span><?php endif; ?></td>
      </tr>
      <tr>
      <td height="35" align="right"><?php echo $this->_tpl_vars['lang']['nav_type']; ?>
...
', 'type', this.value, 'parent')"><?php echo $this->_tpl_vars['lang']['nav_type_bottom']; ?>
      ...
      <!--
	  <label for="type_3">
       <input type="radio" name="type" id="type_3" value="create"<?php if ($this->_tpl_vars['nav_info']['type'] == 'create'): ?> checked="true"<?php endif; ?> onChange="dou_callback('nav.php?rec=nav_select&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')"><?php echo $this->_tpl_vars['lang']['nav_type_create']; ?>
</label>
       -->
	   <label for="type_4">
       <input type="radio" name="type" id="type_4" value="group"<?php if ($this->_tpl_vars['nav_info']['type'] == 'group'): ?> checked="true"<?php endif; ?> onChange="dou_callback('nav.php?rec=nav_select&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')"><?php echo $this->_tpl_vars['lang']['nav_type_group']; ?>
</label>
       <label for="type_5">
       <input type="radio" name="type" id="type_5" value="index"<?php if ($this->_tpl_vars['nav_info']['type'] == 'index'): ?> checked="true"<?php endif; ?> onChange="dou_callback('nav.php?rec=nav_select&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
', 'type', this.value, 'parent')">右浮动栏</label>
      </td>
     </tr>
