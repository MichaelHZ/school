<?php /* Smarty version 2.6.26, created on 2017-10-15 21:14:59
         compiled from blog_list.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'blog_list.htm', 200, false),)), $this); ?>
...
" />
    ...
    <a class="btnGray" href="blog_list.php?rec=sort"><?php echo $this->_tpl_vars['lang']['sort_close']; ?>
</a>
	
    <?php else: ?>
	
    <a class="btnGray" href="blog_list.php?rec=sort"><?php echo $this->_tpl_vars['lang']['sort_article']; ?>
</a>
...
?>
      <li>
       ...
       <a href="blog_list.php?rec=del_sort&id=<?php echo $this->_tpl_vars['article']['id']; ?>
...
">X</a>
    ...
    <form name="action" method="post" action="blog_list.php?rec=action">
...
" /></td>
      ...
      <td><a href="blog_list.php?rec=edit&id=<?php echo $this->_tpl_vars['article']['id']; ?>
...
" target="_blank"><img src="images/icon_picture.png" width="16" height="16" align="absMiddle"></a><?php endif; ?></td>
      <td width="120" align="center"><?php echo $this->_tpl_vars['article']['cat_name']; ?>
</td>
      ...
      <td align="center">
       <?php if ($this->_tpl_vars['if_sort']): ?>
       <a href="blog_list.php?rec=set_sort&id=<?php echo $this->_tpl_vars['article']['id']; ?>
"><?php echo $this->_tpl_vars['lang']['sort_btn']; ?>
</a>
       <?php else: ?>
       <a href="blog_list.php?rec=edit&id=<?php echo $this->_tpl_vars['article']['id']; ?>
"><?php echo $this->_tpl_vars['lang']['edit']; ?>
</a> | 
       <a href="blog_list.php?rec=del&id=<?php echo $this->_tpl_vars['article']['id']; ?>
...
" class="actionBtn"><?php echo $this->_tpl_vars['action_link']['text']; ?>
    ...
    <form action="blog_list.php?rec=<?php echo $this->_tpl_vars['form_action']; ?>
