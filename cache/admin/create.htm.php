<?php /* Smarty version 2.6.26, created on 2017-10-29 16:52:16
...
" class="actionBtn"><?php echo $this->_tpl_vars['action_link']['text']; ?>
    ...
    <div class="navList">
     ...
     <ul class="tab">
       ...
       <li><a href="create.php?type=create" class="selected"><?php echo $this->_tpl_vars['lang']['nav_type_create']; ?>
</a></li>
     </ul>
      -->
...
?>
 ...
 <?php echo $this->_tpl_vars['nav_list']['nav_name']; ?>
       ...
       <td align="center"><a href="create.php?rec=edit&id=<?php echo $this->_tpl_vars['nav_list']['id']; ?>
&cid=<?php echo $this->_tpl_vars['cid']; ?>
"><?php echo $this->_tpl_vars['lang']['edit']; ?>
</a> | <a href="create.php?rec=del&id=<?php echo $this->_tpl_vars['nav_list']['id']; ?>
&cid=<?php echo $this->_tpl_vars['cid']; ?>
"><?php echo $this->_tpl_vars['lang']['del']; ?>
    ...
    <div class="idTabs">
      ...
      <div class="items">
        <div id="nav_add">
         <form action="create.php?rec=insert" method="post">
...
"><?php echo $this->_tpl_vars['catalog']['mark']; ?>
 <?php echo $this->_tpl_vars['catalog']['name']; ?>
           ...
           <tr>
            ...
            <td>
              <label for="type_3">
              <input type="radio" name="type" id="type_3" value="create_<?php echo $this->_tpl_vars['cid']; ?>
" checked="true" onChange="dou_callback('nav.php?rec=nav_select&id=<?php echo $this->_tpl_vars['nav_info']['id']; ?>
...
" />
    ...
    <form action="create.php?rec=update" method="post">
...
" size="40" class="inpMain" />
      ...
      <td>
       <label for="type_3">
       <input type="radio" name="type" id="type_3" value="create_<?php echo $this->_tpl_vars['cid']; ?>
" checked="true" ><?php echo $this->_tpl_vars['lang']['nav_type_create']; ?>
</label>
      </td>
     </tr>
     <tr>
