<?php /* Smarty version 2.6.26, created on 2017-10-15 22:32:48
         compiled from blog_category.htm */ ?>
...
" class="actionBtn add"><?php echo $this->_tpl_vars['action_link']['text']; ?>
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
      ...
      <?php $_from = $this->_tpl_vars['blog_category']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
...
"><?php echo $this->_tpl_vars['cate']['cat_name']; ?>
        ...
        <td align="center"><a href="blog_category.php?rec=edit&cat_id=<?php echo $this->_tpl_vars['cate']['cat_id']; ?>
"><?php echo $this->_tpl_vars['lang']['edit']; ?>
</a> | <a href="blog_category.php?rec=del&cat_id=<?php echo $this->_tpl_vars['cate']['cat_id']; ?>
...
" class="actionBtn"><?php echo $this->_tpl_vars['action_link']['text']; ?>
    ...
    <form action="blog_category.php?rec=<?php echo $this->_tpl_vars['form_action']; ?>
" method="post">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
