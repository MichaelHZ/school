<?php /* Smarty version 2.6.26, created on 2017-11-02 22:29:05
         compiled from special.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'ltrim', 'special.htm', 351, false),array('modifier', 'date_format', 'special.htm', 376, false),)), $this); ?>
...
">X</a>
    ...
    <form name="action" method="post" action="special.php?rec=action">
...
" target="_blank"><img src="images/icon_picture.png" width="16" height="16" align="absMiddle"></a><?php endif; ?></td>
      <td align="center"><?php if ($this->_tpl_vars['article']['cat_name']): ?><a href="special.php?cat_id=<?php echo $this->_tpl_vars['article']['cat_id']; ?>
...
" />
    ...
    <a class="btnGray" href="special.php?rec=sort"><?php echo $this->_tpl_vars['lang']['sort_close']; ?>
</a>
	
    <?php else: ?>
	
    <a class="btnGray" href="special.php?rec=sort"><?php echo $this->_tpl_vars['lang']['sort_article']; ?>
</a>
...
?>
      <li>
       ...
       <a href="special.php?rec=del_sort&id=<?php echo $this->_tpl_vars['article']['id']; ?>
" title="<?php echo $this->_tpl_vars['lang']['sort_cancel']; ?>
">X</a>
      </li>
      <?php endforeach; endif; unset($_from); ?>
...
" /></td>
      ...
      <td><a href="special.php?rec=edit&id=<?php echo $this->_tpl_vars['article']['id']; ?>
"><?php echo $this->_tpl_vars['article']['title']; ?>
</a><?php if ($this->_tpl_vars['article']['image']): ?> <a href="../<?php echo $this->_tpl_vars['article']['image']; ?>
" target="_blank"><img src="images/icon_picture.png" width="16" height="16" align="absMiddle"></a><?php endif; ?></td>
      <td align="center"><?php if ($this->_tpl_vars['article']['cat_name']): ?><a href="special.php?cat_id=<?php echo $this->_tpl_vars['article']['cat_id']; ?>
...
" data_val="0" src="/admin/images/no.gif"><?php endif; ?>
      ...
      <td align="center">
       <?php if ($this->_tpl_vars['if_sort']): ?>
       <a href="special.php?rec=set_sort&id=<?php echo $this->_tpl_vars['article']['id']; ?>
 "><?php echo $this->_tpl_vars['lang']['sort_btn']; ?>
</a>
       <?php else: ?>
       <?php if ($this->_tpl_vars['IS_ADMIN']): ?>
       		<a href="special.php?rec=edit&id=<?php echo $this->_tpl_vars['article']['id']; ?>
"><?php echo $this->_tpl_vars['lang']['edit']; ?>
</a>
       		| 
       			<a href="special.php?rec=del&id=<?php echo $this->_tpl_vars['article']['id']; ?>
      ...
      <script>
      	$(function(){
      		...
      		$(".active").click(function(){
      			...
      			obj = $(this);
      			$.post("/admin/special_category.php",{rec:\'active\',val:val,id:id},function(data){
      				   if(data == \'success\'){
      					   if(val == 1){
...
" class="actionBtn"><?php echo $this->_tpl_vars['action_link']['text']; ?>
    ...
    <form action="special.php?rec=<?php echo $this->_tpl_vars['form_action']; ?>
